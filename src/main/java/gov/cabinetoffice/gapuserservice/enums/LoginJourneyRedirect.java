...
import gov.cabinetoffice.gapuserservice.util.EncodeURIComponent;
import gov.cabinetoffice.gapuserservice.util.WebUtil;

import java.util.Arrays;
import java.util.List;

import static gov.cabinetoffice.gapuserservice.web.LoginControllerV2.PRIVACY_POLICY_PAGE_VIEW;
import static gov.cabinetoffice.gapuserservice.web.LoginControllerV2.UPDATED_EMAIL_PAGE_VIEW;
